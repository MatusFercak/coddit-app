    ...
    <div class="container">
        <div class="row">
            <div class="d-flex mt-5 justify-content-between align-items-center">
                ...
                {#if $user !== null}
                    <div><button type="button" class="btn btn-primary" on:click={createPost}>Add post.</button></div>
                {/if}
            </div>
            <h3 class="mt-1 mx-5">{subCoddit?.description}</h3>
        </div>
    </div>
</div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="/c/{subCodId}/{p.$id}"><button href="/c/{subCodId}/{p.$id}" type="button" class="btn btn-sm btn-outline-secondary">Read</button></a>
                            </div>
